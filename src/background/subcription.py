...
class Subscription:
    ...
    PRO_SUBSCRIPTION_BASE_PRICE_ID = "price_1QBmFMKfLZqN2X3WL0H7dHm4" if os.environ["SERVER_ENVIRONMENT"] == "production" and not TESTING_STRIPE else PRO_SUBSCRIPTION_BASE_PRICE_TEST_ID
    PRO_SUBCRIPTION_TEST_ID = "prod_R40ppWMFQ1pXtu"
    PRO_SUBSCRIPTION_ID = "prod_R3u3Q6oY9Z7PsZ" if os.environ["SERVER_ENVIRONMENT"] == "production" and not TESTING_STRIPE else PRO_SUBCRIPTION_TEST_ID
